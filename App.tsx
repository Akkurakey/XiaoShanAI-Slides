...
import { CoreFeatures } from './components/slides/CoreFeatures';
...
import { Community } from './components/slides/Community';
...
export default function App() {
  ...
  const renderSlide = () => {
    ...
    switch(currentSlide) {
      ...
      case 3: return <UseCases key="usecases" {...commonProps} />;
      case 4: return <VideoDemo key="videodemo" {...commonProps} />;
      case 5: return <Architecture key="architecture" {...commonProps} />;
      case 6: return <CoreFeatures key="corefeatures" {...commonProps} />;
      case 7: return <Demo key="demo" {...commonProps} />;
      case 8: return <Partnerships key="partnerships" {...commonProps} />;
      case 9: return <Requirements key="requirements" {...commonProps} />;
      case 10: return <Impact key="impact" {...commonProps} />;
      case 11: return <Future key="future" {...commonProps} />;
      case 12: return <Community key="community" {...commonProps} />;
      case 13: return <End key="end" {...commonProps} />;
